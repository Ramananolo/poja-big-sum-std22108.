package com.poja.big-sum-std22108.unit;
...
import com.poja.big-sum-std22108.endpoint.event.EventConsumer;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja.big-sum-std22108.endpoint.event.gen.UuidCreated", payload);
